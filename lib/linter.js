    ...
    Linter.prototype.lint = function (fileName, source, configuration) {
        ...
        if (this.options.fix) {
            ...
            for (var _i = 0, enabledRules_1 = enabledRules; _i < enabledRules_1.length; _i++) {
                ...
                var fileFailures = this.applyRule(rule, sourceFile);
                var fixes = fileFailures.map(function (f) { return f.getFix(); }).filter(function (f) { return !!f; });
